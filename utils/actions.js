...
export const getRestaurantReviews = async(idRestaurant) => {
...
export const getToken = async() => {
    if(!Constants.isDevice) {
        Alert.alert("Debes utilizar un dispositivo físico para poder usar las notificaciones.")
        return
    }
    ...
    if(finalStatus !== "granted") {
        Alert.alert("Debes proporcionar permisos para acceder a las notificaciones.")
        return
    }
